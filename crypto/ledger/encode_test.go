...
// Example demonstrating the codec's PrintTypes method
// This example shows the registered types in the amino codec.
// Uncomment to run:
/*
func Example_printTypes() { //nolint:govet // ignore for examples
