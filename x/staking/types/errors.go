...
var (
	...
	ErrPendingQueueSlotMissingCount         = errors.Register(ModuleName, 46, "pending queue slot missing count")
	ErrPendingQueueSlotInsufficientCapacity = errors.Register(ModuleName, 47, "pending queue slot insufficient capacity")
)
